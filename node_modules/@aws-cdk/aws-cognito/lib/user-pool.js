...
class UserPool extends UserPoolBase {
    ...
    constructor(scope, id, props = {}) {
        ...
        const selfSignUpEnabled = (_d = props.selfSignUpEnabled) !== null && _d !== void 0 ? _d : false;
        ...
        const userPool = new cognito_generated_1.CfnUserPool(this, 'Resource', {
            ...
            emailConfiguration: undefinedIfNoKeys({
                from: encodePuny((_e = props.emailSettings) === null || _e === void 0 ? void 0 : _e.from),
                replyToEmailAddress: encodePuny((_f = props.emailSettings) === null || _f === void 0 ? void 0 : _f.replyTo),
            }),
