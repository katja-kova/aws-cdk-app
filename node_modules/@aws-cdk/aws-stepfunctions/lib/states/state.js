...
class State extends core_1.Construct {
    ...
    _addRetry(props = {}) {
        ...
        this.retries.push({
            ...props,
            errors: (_a = props.errors) !== null && _a !== void 0 ? _a : [types_1.Errors.ALL],
        });
    }
    /**
    ...
    renderChoices() {
        ...
        return {
            ...
            Default: (_a = this.defaultChoice) === null || _a === void 0 ? void 0 : _a.stateId,
        };
    }
    /**
