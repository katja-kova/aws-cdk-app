...
export declare function BuildSagemakerEndpoint(scope: cdk.Construct, props: BuildSagemakerEndpointProps): [sagemaker.CfnEndpoint, sagemaker.CfnEndpointConfig?, sagemaker.CfnModel?];
export declare function deploySagemakerEndpoint(scope: cdk.Construct, props: BuildSagemakerEndpointProps): [sagemaker.CfnEndpoint, sagemaker.CfnEndpointConfig?, sagemaker.CfnModel?];
export declare function createSagemakerModel(scope: cdk.Construct, modelProps: sagemaker.CfnModelProps, role: iam.Role, vpc?: ec2.IVpc): sagemaker.CfnModel;
export declare function createSagemakerEndpointConfig(scope: cdk.Construct, modelName: string, endpointConfigProps?: sagemaker.CfnEndpointConfigProps): sagemaker.CfnEndpointConfig;
export declare function createSagemakerEndpoint(scope: cdk.Construct, endpointConfigName: string, endpointProps?: sagemaker.CfnEndpointProps): sagemaker.CfnEndpoint;
