...
class ResourceBase extends core_1.Resource {
    ...
    addCorsPreflight(options) {
        ...
        //
        // statusCode
        const statusCode = (_a = options.statusCode) !== null && _a !== void 0 ? _a : 204;
        //
...
class ProxyResource extends Resource {
    ...
    constructor(scope, id, props) {
        ...
        const anyMethod = (_a = props.anyMethod) !== null && _a !== void 0 ? _a : true;
        if (anyMethod) {
